...
public class CreateCollectionWindow extends AbstractWindow {
    ...
    public void load() throws IOException {
        ...
        FXMLLoader fxmlLoader = new FXMLLoader(BaseApplication.class.getResource("createCollection.fxml"));
